...
public class ModelTest {
	...
	public void TestHashMapsofTaskPairs(){
		Task t1 = new Task(1,"test", "potential and actual score map", "OS", "Platform", "Component", "Owner", "Description");
		Task t2 = new Task(2, "test", "potential and actual score map", "OS", "Platform", "Component", "Owner", "Description");
